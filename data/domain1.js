...
window.DOMAINS["domain1"] = {
  ...
  taskStatements: [
    ...
    // =========================================================================
    {
      ...
      summary: {
        keyPoints: [
          { icon: "definition", text: "Artificial Intelligence (AI) is the field of computer science dedicated to solving cognitive problems commonly associated with human intelligence, such as learning, creation, and image recognition. The goal is to create self-learning systems that derive meaning from data." },
          ...
          { icon: "concept", text: "Supervised learning uses pre-labeled training data (input + expected output). Unsupervised learning finds patterns in unlabeled data (clustering, anomaly detection). Reinforcement learning uses an agent that learns through trial and error with rewards for goal-directed actions." },
          { icon: "concept", text: "Model artifacts (trained parameters, model definition, metadata) are stored in S3. Inference can be real-time (persistent endpoint, low latency) or batch (offline processing, cost-effective for large datasets where waiting for results is acceptable)." },
      ...
      flashcards: [
        ...
        { front: "What is Deep Learning?", back: "Deep learning is a type of ML that uses algorithmic structures called neural networks (inspired by the human brain) with layers of interconnected nodes. It excels at image classification, NLP, and tasks requiring identification of complex data relationships." },
    ...
    // =========================================================================
    {
      ...
      summary: {
        keyPoints: [
          { icon: "concept", text: "The ML pipeline is a series of interconnected steps: (1) Define the business goal, (2) Collect and prepare data, (3) Train, tune, and evaluate the model, (4) Deploy for inference, (5) Monitor. It is a lifecycle — parts or all of it are repeated even after deployment." },
          ...
          { icon: "concept", text: "Approach hierarchy: (1) Use AWS pre-trained AI services (pay-as-you-go, some customizable). (2) Fine-tune an existing model with your data via transfer learning (e.g., Bedrock foundation models, SageMaker JumpStart). (3) Train a custom model from scratch (most costly, technically challenging)." },
