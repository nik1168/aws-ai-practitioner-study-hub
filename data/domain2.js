    ...
    // =========================================================================
    {
      ...
      summary: {
        keyPoints: [
          ...
          { icon: "concept", text: "Transformer architecture (introduced in 2017 paper 'Attention Is All You Need') is the core of modern generative AI. It processes entire input sequences in parallel using a self-attention mechanism, unlike traditional neural networks (RNNs, CNNs) that process sequentially." },
          ...
          { icon: "concept", text: "In-context learning helps LLMs by including examples in the prompt. Zero-shot (no examples), one-shot (one example), and few-shot (multiple examples) inference guide model behavior without retraining. Prompt engineering optimizes prompts for better outputs." },
          ...
          { icon: "concept", text: "Diffusion models learn to reverse a gradual noising process: forward diffusion adds noise to data, reverse diffusion iteratively de-noises random noise into coherent output. They produce higher quality, more diverse, and more stable results than GANs and VAEs." },
          ...
          { icon: "concept", text: "Generative AI project lifecycle: (1) Identify use case, (2) Experiment and select model, (3) Adapt/align/augment (prompt engineering, fine-tuning, RLHF), (4) Evaluate, (5) Deploy and iterate, (6) Monitor. Start with prompt engineering before fine-tuning." },
          { icon: "definition", text: "Fine-tuning is supervised learning to further train a model on a specific dataset. RLHF (Reinforcement Learning from Human Feedback) aligns model behavior with human preferences. Transfer learning uses a pre-trained model as a starting point, requiring less data and time." },
      ...
      flashcards: [
        ...
        { front: "What are the stages of the generative AI project lifecycle?", back: "1) Identify use case. 2) Experiment and select model. 3) Adapt, align, augment (prompt engineering → fine-tuning → RLHF). 4) Evaluate. 5) Deploy and iterate. 6) Monitor. Always start with prompt engineering before moving to fine-tuning." },
    ...
    // =========================================================================
    {
      ...
      summary: {
        keyPoints: [
          ...
          { icon: "concept", text: "AWS ML Stack (bottom to top): 1) Infrastructure Layer — Regions, Availability Zones, Edge locations. 2) ML Services Layer — SageMaker and managed ML services. 3) AI Services Layer — prebuilt services, algorithms, and models (highest-level abstractions, no ML expertise needed)." },
          ...
          { icon: "concept", text: "Three-layer generative AI security model: Bottom (tools for building/training, hardware, guardrails), Middle (access to models, ML services for training/tuning), Top (applications using LLMs — dashboards, prompt engineering, RAG). Each layer has different security considerations." },
      ...
      flashcards: [
        ...
        { front: "What are the three layers of the AWS ML Stack?", back: "1) Infrastructure Layer — Regions, Availability Zones, Edge locations. 2) ML Services Layer — SageMaker and managed ML services. 3) AI Services Layer — prebuilt services, algorithms, and models (highest abstraction, no ML expertise needed)." },
        ...
        { front: "What are the three layers of the generative AI security model?", back: "Bottom: tools for building/training LLMs, hardware demands, guardrails. Middle: access to models and ML services for training/tuning. Top: applications using LLMs/FMs (dashboards, prompt engineering, RAG)." },
